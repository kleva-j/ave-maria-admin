...
export declare const components: {
  ...
  savingsPlanAmountByUserAndTemplate: {
    btree: {
      aggregateBetween: FunctionReference<
        "query",
        "internal",
